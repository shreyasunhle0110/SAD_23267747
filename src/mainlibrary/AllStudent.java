...
public class AllStudent extends javax.swing.JFrame {
     ...
     * @see <a href="https://cwe.mitre.org/data/definitions/404.html">CWE-404:
     *      Improper Resource Shutdown or Release</a>
     */
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_SearchActionPerformed
        ...
        String query = null;
        boolean isName = NameRadio.isSelected();
        boolean isEmail = AuthorRadio.isSelected();
        ...
        if (query != null) {
            fillTableWithQuery(model, query, searchText);
        } else {
    ...
    private void fillTableWithQuery(DefaultTableModel model, String query, String param) {
        try (Connection Con = DB.getConnection();
